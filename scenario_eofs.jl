...
using NCDatasets
data_directory = "/net/fs06/d3/CMIP5/MPI-GE/RCP85/ts"
file = "ts_Amon_MPI-ESM_rcp85_r" * string(100) * "i2005p3_200601-209912.nc"
...
##
data_directory = "/net/fs06/d3/CMIP5/MPI-GE/RCP85/ts"
file = "ts_Amon_MPI-ESM_rcp85_r" * "001" * "i2005p3_200601-209912.nc"
filepath = joinpath(data_directory, file)
ds = Dataset(filepath)
...
display(fig)
save("rcp85_eofs.png", fig, px_per_unit = 2)
...
display(fig)
save("rcp85_higher_modes_eofs.png", fig, px_per_unit = 2)
...
display(fig)
save("rcp85_eofs_diffs.png", fig, px_per_unit = 2)

##
avg_temp = mean(temperature ,dims = (1,2))[:]