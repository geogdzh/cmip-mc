...
# write(hfile, "mean_coefs_1", mean_coefs)
...
# hfile = using_precip ? h5open("data/temp_precip/gaussian_emulator_withpr_$(scenario)_$(d)d.hdf5", "cw") : h5open("data/temp_only/gaussian_emulator_$(scenario)_$(d)d.hdf5", "w")
